...
// Check if PartsDataManager is already defined to prevent duplicate declarations
if (typeof PartsDataManager === 'undefined') {
    ...
    console.log('✅ PartsDataManager class defined successfully');

} else {
    console.log('⚠️ PartsDataManager already exists, skipping class definition');
}


// Create global instance only if class is properly defined
try {
    if (typeof PartsDataManager !== 'undefined' && typeof PartsDataManager === 'function') {
        if (!window.partsDataManager) {
            window.partsDataManager = new PartsDataManager();
            console.log('✅ PartsDataManager instance created');
        } else {
            console.log('⚠️ PartsDataManager instance already exists');
        }
    } else {
        console.warn('⚠️ PartsDataManager class not properly defined');
    }
} catch (error) {
    console.error('❌ Error creating PartsDataManager instance:', error);
}
